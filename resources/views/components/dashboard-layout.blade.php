<!DOCTYPE html>
<html lang="en">
@include('components.dashboard-layout-header')

<body class="is-header-blur navigation:horizontal">
    <!-- Page Wrapper -->
                    ...
                    <div class="nav-wrapper h-[calc(100%-4.5rem)] overflow-x-hidden pb-6" data-simplebar>
                        <ul class="flex flex-1 flex-col px-4 font-inter">
                            <li
                                ...
                                <ul class="ac-panel">
                                    <li>
                                        <a href="pages-onboarding-1.html"
                                    ...
                                    <li>
                                        <a href="pages-onboarding-2.html"
                                            class="nav-link flex items-center justify-between p-2 text-xs+ tracking-wide outline-none transition-[color,padding-left] duration-300 ease-in-out hover:pl-4"
                                            data-default-class="text-slate-600 hover:text-slate-800 dark:text-navy-200 dark:hover:text-navy-50"
                                            data-active-class="font-medium text-primary dark:text-accent-light">
                                            <div class="flex items-center space-x-2">
                            ...
                            <li
                                ...
                                <ul class="ac-panel">
                                    <li>
                                        <a href="pages-price-list-1.html"
                                            class="nav-link flex items-center justify-between p-2 text-xs+ tracking-wide outline-none transition-[color,padding-left] duration-300 ease-in-out hover:pl-4"
                                            data-default-class="text-slate-600 hover:text-slate-800 dark:text-navy-200 dark:hover:text-navy-50"
                                            data-active-class="font-medium text-primary dark:text-accent-light">
                                            <div class="flex items-center space-x-2">
                                    ...
                                    <li>
                                        <a href="pages-price-list-2.html"
                                            class="nav-link flex items-center justify-between p-2 text-xs+ tracking-wide outline-none transition-[color,padding-left] duration-300 ease-in-out hover:pl-4"
                                            data-default-class="text-slate-600 hover:text-slate-800 dark:text-navy-200 dark:hover:text-navy-50"
                                            data-active-class="font-medium text-primary dark:text-accent-light">
                                            <div class="flex items-center space-x-2">
                                    ...
                                    <li>
                                        <a href="pages-price-list-3.html"
                                            class="nav-link flex items-center justify-between p-2 text-xs+ tracking-wide outline-none transition-[color,padding-left] duration-300 ease-in-out hover:pl-4"
                                            data-default-class="text-slate-600 hover:text-slate-800 dark:text-navy-200 dark:hover:text-navy-50"
                                            data-active-class="font-medium text-primary dark:text-accent-light">
                                            <div class="flex items-center space-x-2">
                ...
                <div class="flex w-full items-center justify-between sm:h-16">
                    ...
                    <div class="-mr-1.5 flex items-center space-x-2">
                        ...
                        <div id="searchbar-wrapper" class="hidden sm:flex">
                            ...
                            <div id="searchbar-box" data-active-tab="#search-all"
                    ...
                    <div class="pointer-events-none absolute bottom-4 flex w-full justify-center">
                        <div
                            ...
                            <button data-target="#right-sidebar-tab-project"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" class="h-5 w-5 shrink-0"
                                    viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M7 12l3-3 3 3 4-4M8 21l4-4 4 4M3 4h18M4 4h16v12a1 1 0 01-1 1H5a1 1 0 01-1-1V4z" />
                                </svg>
